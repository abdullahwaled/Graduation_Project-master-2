                ...
                <div className='row'>
                    <div className='col-lg-7 mx-auto'>
                        <div className='reg-top'>
                            ...
                            <Link to='/loginOwaner' className='sec-btn'>Login</Link>
                        </div>
                        <div className='project-name'>Baby Daycare</div>
                        <div className='tabs-m'>
                            <Link to='/regOwaner' className='tab-m active'>
                                <img src={radio_button_ac} alt='radio_button_ac' />
                                Owner
                            </Link>
                            <Link to='/regParent' className='tab-m'>
