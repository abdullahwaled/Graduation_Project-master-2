...
import './home.css';
import img1 from '../../asset/image/41.jpg';
import img2 from '../../asset/image/40.jpg';
...
import img38 from '../../asset/image/38.png';
...
export default function Home() {
  ...
  return (
    <div className='home'>
      ...
      <section className="box text-center text-sm-start py-5 mt-5">
        <div className="container">
      ...
      <section className="box text-center text-sm-start mb-5">
        <div className="container">
          <div className="d-sm-flex align-items-center justify-content-around">
            <Box>
      ...
      <section className="pt-2 parent row w-100 m-auto">
